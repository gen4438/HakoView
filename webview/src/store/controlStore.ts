  ...
  subscribeWithSelector((zustandSet, zustandGet) => ({
    ...
    resetDisplay: () => {
      zustandSet({
        ...
        smoothMode: DEFAULT_CONTROL_STATE.smoothMode,
        smoothStepSize: DEFAULT_CONTROL_STATE.smoothStepSize,
        smoothRefineIterations: DEFAULT_CONTROL_STATE.smoothRefineIterations,
        smoothMovingStepSize: DEFAULT_CONTROL_STATE.smoothMovingStepSize,
        smoothMovingRefineIterations: DEFAULT_CONTROL_STATE.smoothMovingRefineIterations,
