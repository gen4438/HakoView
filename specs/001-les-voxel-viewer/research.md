...
- **1000³**: パース8-10秒 + プログレッシブ表示2-3秒 = 計10-13秒（目標15秒以内）
- **操作時FPS**: 200³で30fps以上、1000³で20fps以上
...
- `benchmark_1000x1000x1000_sparse.leS` - 大規模疎データ
